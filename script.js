...
document.addEventListener(
    ...
    function () {
        ...
        const storyMessages = [
            ...
            `
            اون تایمی که باهم شب ها بیرون بیودیم <br>
            ... خیلی خوب بود<br>
            ... چطوری بگم
            `,

            `
            می‌دونی خوش میگذشت  <br>
            تایم از دستم خارج بود و برام مهم نبود 
            `,

            `
            ... ولی یه اتفاقی همون تایم افتاد که راستش درگیرم داشت <br>
            رفتارم هم بخاطر فشار اون اتفاق بود 
            `,
            ...
            `
           میدونی که من زیاد طبس نیستم ولی اینا رو کفتم چون <br>
           میخواستم قبل اینکه دوباره برم تهران ببینمت 
            `,
            
            `
            از وقتی اومدم دلم میخواستم ببینمت <br>
            `,
            
            `
            این همه راه رو باهم اومدیم <br>
            فقط برای اینکه آخرش ازت یه چیز کوچیک بخوام <br>
            میشه شب هم رو ببینیم؟<br>
            <br>
            ... البته دو نفره <br>
            🐈😂 ! بدون خانم گربه
            `
