...
alert(
    "⚠️ توجه\n\n" +
    "این صفحه برای استفاده از برخی سرویس‌ها و پلتفرم‌های معتبر خارجی طراحی شده است.\n\n" +
    "به دلیل محدودیت‌های دسترسی، ممکن است بدون VPN بعضی از امکانات و قابلیت‌های صفحه به‌درستی اجرا نشوند.\n\n" +
    "برای تجربه کامل سفر، لطفاً با VPN وارد شوید 🌙✨"
);
